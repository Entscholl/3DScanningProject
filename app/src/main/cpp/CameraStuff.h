...
namespace StereoReconstruction {
    ...
    private:
        struct Request {
            ...
            ACameraCaptureSession *camera_session;
    ...
    private:
        ...
        void take_picture(ACameraDevice_request_template template_id, ACameraDevice *_device,
                Format format);
        void start_preview(ACameraDevice_request_template template_id, ACameraDevice *_device);
        void close();
    public:
        ...
        static void init(JNIEnv* const env, const jobject surface) {
            ...
            instance().start_preview(TEMPLATE_PREVIEW, instance().camera_device);
        ...
        static void take_picture(cv::Mat *_output) {
            instance().take_picture(TEMPLATE_PREVIEW, instance().camera_device ,
                    Format(640, 480, AIMAGE_FORMAT_YUV_420_888));
            //          Format(640, 480, AIMAGE_FORMAT_JPEG));
            output_mat = _output;
        }
    };
}
